                ...
                <div className="navbar-fixed">
                    ...
                    {this.props.loggedIn
                        ? (
                            <ul id="dropdown1" className="dropdown-content">
                                ...
                                <li><a className="waves-effect waves-light black-text" onClick={this.logout}>Logout</a></li>
                            </ul>
                        )
                        : ""
                    }
                    ...
                    <nav>
                        <div className="nav-wrapper grey lighten-5">
                            <Link to="/" className="brand-logo blue-text thin accent-3" >
                                <img className="navLogo" src="https://c2.staticflickr.com/6/5697/23990114051_04ab0c6e33_b.jpg" />
                            </Link>
                            <a href="#" data-activates="mobile-demo" className="button-collapse black-text">
                            ...
                            <ul className="right hide-on-med-and-down">
                                ...
                                {this.props.loggedIn
                                    ? (
                                        <li>
                                            <Link className="dropdown-button black-text" data-activates="dropdown1" to="/dashboard">
                                                Dashboard
                                        ...
                                        <li>
                                            <Link className="waves-effect waves-light black-text" to="/login">
                                                Login/Signup
                                            </Link>
                                        </li>
                                    )
                            ...
                            <ul className="side-nav" id="mobile-demo">
                                ...
                                {this.props.loggedIn ? (
                                    <li>
                                        <Link className="dropdown-button black-text" data-activates="dropdown2" to="/dashboard">
                                            Dashboard
                                            <i className="material-icons black-text right">arrow_drop_down</i>
                                        </Link>
                                    </li>
